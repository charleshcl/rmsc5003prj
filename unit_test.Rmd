...
```{r historic data of 2008-2009 }
price_AAPL <- as.numeric(getSymbols("AAPL", from ="2008-03-01", to = "2009-03-03", auto.assign = FALSE)$AAPL.Close)
price_AMZN <- as.numeric(getSymbols("AMZN", from ="2008-03-01", to = "2009-03-03", auto.assign = FALSE)$AMZN.Close)
