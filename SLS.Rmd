...
#       garchPftlRet1y = (rsBEKK_AAPL$acctVal1y+rsBEKK_AMZN$acctVal1y-sum_V_0)/sum_V_0
      ...
      hist( gbmPftlRet1y,   main=paste("Histogram of Portfolio Return under BS Model with \n alpha =", a, " beta =", b, " K=", k, "T = 1 Year"), xlim =c(min(gbmPftlRet1y)-0.1, max(gbmPftlRet1y)+0.1),breaks = 20, xlab="Return")
      dens=density(gbmPftlRet1y)
      lines(dens$x,length(gbmPftlRet1y) * (max(gbmPftlRet1y) - min(gbmPftlRet1y)) *dens$y / 20) 
      hist( garchPftlRet1y, main=paste("Histogram of Portfolio Return under GARCH Model with \n alpha =", a, " beta =", b, " K=", k, "T = 1 Year"), xlim =c(min(garchPftlRet1y)-0.1, max(garchPftlRet1y)+0.1),breaks = 20, xlab="Return")
