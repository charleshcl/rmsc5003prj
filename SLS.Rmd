...
for (a in seq(from=0.5, to=0.5, by=0.5)) {
  for (b in seq(from=0.5, to=0.5, by=0.5)) {
    for (k in seq(from=1, to=1, by=1)) {
      ...
      # plot histogram
      hist( (rsS1$acctVal1y+rsS2$acctVal1y-sum_V_0) / sum_V_0, main=paste("Histogram of GBM Histogram: alpha =", a, " beta =", b, " K=", k))
      hist( (rsBEKK_AAPL$return1y+rsBEKK_AMZN$return1y-sum_V_0)/sum_V_0, main=paste("Histogram of GARCH Histogram: alpha =", a, " beta =", b, " K=", k))
