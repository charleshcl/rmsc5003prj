...
for (a in seq(from=0.5, to=0.5, by=0.5)) {
  for (b in seq(from=0.5, to=0.5, by=0.5)) {
    for (k in seq(from=1, to=1, by=1)) {
      ...
      sample = apply( (rsS2$allV + rsS2$allV - sum(V_0)) / sum(V_0), 2, quantile, probs=c(0.01, 0.5, 0.99))
      ...
      sample = apply( (rsBEKK_AAPL$allV + rsBEKK_AMZN$allV - sum(V_0)) / sum(V_0), 2, quantile, probs=c(0.01, 0.5, 0.99))
