...
#       garchPftlRet1y = (rsBEKK_AAPL$acctVal1y+rsBEKK_AMZN$acctVal1y-sum_V_0)/sum_V_0
      ...
      plot.zoo(t( (rsBS_ptfl$allV - sum_V_0) / sum_V_0 ), main = paste("Sample Return Paths and Empirical Confidence Envelope (BS Model)", "alpha =", a, " beta =", b, " K=", k), xlab="t", ylab="Portfolio Return", plot.type = "single")
      ...
      plot.zoo(t((rsBEKK_ptfl$allV - sum_V_0) / sum_V_0), main = paste("Sample Return Paths and Empirical Confidence Envelope (BEKK Model)", "alpha =", a, " beta =", b, " K=", k), xlab="t", ylab="Portfolio Return", plot.type = "single")
      lines(sample[1,],col="Red",lwd=2)
      lines(sample[2,],col="Red",lwd=2)
      lines(sample[3,],col="Red",lwd=2)
